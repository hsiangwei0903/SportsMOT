...
def dti(txt_path, save_path, n_min=25, n_dti=20):
    ...
    for seq_id,seq_txt in enumerate(seq_txts):
        seq_name = seq_txt.split('/')[-1]
        print('processing seq {}/{}'.format(seq_id+1,len(seq_txts)))
...
if __name__ == '__main__':
    ...
    txt_path = '/home/u1436961/hsiangwei/sportsmot/OC_SORT/post_processing/'
    save_path = '/home/u1436961/hsiangwei/sportsmot/OC_SORT/result/interpolation/'
