...
def make_parser():
    ...
    parser.add_argument(
        "-f", "--exp_file",
        default="/home/u1436961/hsiangwei/sportsmot/OC_SORT/exps/example/mot/yolox_x_ch.py",
        type=str,
    ...
    parser.add_argument("--reid", dest="reid", default=False, action="store_true", help="use reid in tracking.")
    ...
    parser.add_argument( "--path", default="/work/u1436961/hsiangwei/dataset/test/", help="path to images or video")
